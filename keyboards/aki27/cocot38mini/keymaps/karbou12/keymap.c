...
static const uint16_t PROGMEM km_combo2[] = COMBO_KEY_MS_ACL1;
static const uint16_t PROGMEM km_combo3[] = COMBO_KEY_MS_ACL2;
const combo_t km_key_combos[] = {
    COMBO(km_combo1, COMBO_OUT_MS_ACL0),
    COMBO(km_combo2, COMBO_OUT_MS_ACL1),
    COMBO(km_combo3, COMBO_OUT_MS_ACL2),
};
