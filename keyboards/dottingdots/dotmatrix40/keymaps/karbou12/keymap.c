...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_wrapper(
        MAC_QAZ40_BASE_LEFT_TOP,                       MS_BTN2, MAC_QAZ_BASE_RIGHT_TOP,
        MAC_QAZ40_BASE_LEFT_MIDDLE,                    MS_BTN3, MAC_QAZ_BASE_RIGHT_MIDDLE,
        MAC_QAZ40_BASE_LEFT_BOTTOM,                    MS_BTN1, MAC_QAZ_BASE_RIGHT_BOTTOM,
    ...
    [2] = LAYOUT_wrapper(
        ...
        MAC_QAZ40_LOWER_LEFT_MIDDLE,                    LGUI(KC_0), MAC_QAZ_LOWER_RIGHT_MIDDLE,
        MAC_QAZ40_LOWER_LEFT_BOTTOM,                    LAG(KC_8),  MAC_QAZ_LOWER_RIGHT_BOTTOM,
