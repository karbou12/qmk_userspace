...
const hsv_t PROGMEM km_hsv_layer0[]   = HSV_LAYER_SEGMENTS({HSV_MAGENTA});
const hsv_t PROGMEM km_hsv_layer1[]   = HSV_LAYER_SEGMENTS({HSV_CYAN});
const hsv_t PROGMEM km_hsv_layer2[]   = HSV_LAYER_SEGMENTS({HSV_BLUE});
const hsv_t PROGMEM km_hsv_layer3[]   = HSV_LAYER_SEGMENTS({HSV_GREEN});
const hsv_t PROGMEM km_hsv_layer4[]   = HSV_LAYER_SEGMENTS({HSV_PURPLE});
const hsv_t PROGMEM km_hsv_layer5[]   = HSV_LAYER_SEGMENTS({HSV_CYAN});
const hsv_t PROGMEM km_hsv_layer6[]   = HSV_LAYER_SEGMENTS({HSV_BLUE});
const hsv_t PROGMEM km_hsv_layer7[]   = HSV_LAYER_SEGMENTS({HSV_GREEN});
