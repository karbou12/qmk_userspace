...
const rgblight_segment_t PROGMEM km_layer4_layer[]   = RGBLIGHT_LAYER_SEGMENTS({0, 1, HSV_YELLOW});
const rgblight_segment_t PROGMEM km_layer5_layer[]   = RGBLIGHT_LAYER_SEGMENTS({0, 1, HSV_PURPLE});
const rgblight_segment_t PROGMEM km_layer6_layer[]   = RGBLIGHT_LAYER_SEGMENTS({0, 1, HSV_AZURE});
const rgblight_segment_t PROGMEM km_layer7_layer[]   = RGBLIGHT_LAYER_SEGMENTS({0, 1, HSV_SPRINGGREEN});
const rgblight_segment_t PROGMEM km_layer8_layer[]   = RGBLIGHT_LAYER_SEGMENTS({0, 1, HSV_ORANGE});
